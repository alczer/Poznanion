...
public class CameraManager : MonoBehaviour {
    ...
    // checks if camera limits need to be updated
    ...
    private bool useEdgePanning = false;

    public void UpdateCamera()
    {
        Xmax = 10 + maxX * moveIncrease;
        Xmin = -10 + minX * moveIncrease;
        Zmax = 10 - minZ * moveIncrease;
        Zmin = -10 - maxZ * moveIncrease;
    }
    ...
    void Update()
    {
        ...
        if (dontUseTouch)
        {
            ...
            // Edge panning
            if (!isZooming && !isRotating && !isPanning && useEdgePanning)
            {
